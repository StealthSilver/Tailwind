  ...
  return (
    <div className="flex flex-col items-center gap-4">
      ...
      <div className="flex flex-col md:flex-row items-center gap-10 mt-10">
        <div className="h-40 w-40 pogo:w-10 rounded-xl bg-red-300"></div>
        <div className="h-40 w-40 pogo:w-10  rounded-xl bg-green-300"></div>
        <div className="h-40 w-40 pogo:w-10  rounded-xl bg-blue-300"></div>
      </div>
    </div>
  );
};
